function createElem(type, classNames = [], attrs = {}) {
  ...
  function buildPage() {
    ...
    row1.appendChild(crearCardProducto('src/imagen/imag-produc-herr/produc-herr-1.svg', 'Tijera De Poda Jardinería Mango Recubierto Ferreco Basics', '$20.900'));
    row1.appendChild(crearCardProducto('src/imagen/imag-produc-herr/produc-herr-2.svg', 'Tijera Para Podar Ramas 21\'\' Mango Tubular Truper 18399', '$49.900'));
    row1.appendChild(crearCardProducto('src/imagen/imag-produc-herr/produc-herr-3.svg', 'Paladraga 35.5x13.9cm Calibre 16 Herragro', '$95.715'));
    ...
    row2.appendChild(crearCardProducto('src/imagen/imag-produc-herr/produc-herr-4.svg', 'Expulso de Agua manual, herraimenta Agrícola', '$75.000'));
    row2.appendChild(crearCardProducto('src/imagen/imag-produc-herr/produc-herr-5.svg', 'Mqhuayu Herramientas De Jardinería. Juego de Herramientas.', '$284.900'));
    row2.appendChild(crearCardProducto('src/imagen/imag-produc-herr/produc-herr-6.svg', 'Juego Herramientas Para Jardín 4 Piezas, 6 Truper 15030', '$49.000'));
