function createElem(type, classNames = [], attrs = {}) {
  ...
  function buildPage() {
    ...
    const logo = createElem('img', ['logo'], {
      src: 'src/imagen/imag-inicio/3.svg',
      alt: 'Logo',
    });
    ...
    const favImg = createElem('img', ['favoritos-logo'], { src: 'src/imagen/favoritos.svg', alt: 'favoritos' });
    favLink.appendChild(favImg);
    botonesInicio.appendChild(favLink);
  
    const cartLink = createElem('a', [], { href: 'carro-compras.html' });
    const cartImg = createElem('img', ['carro-compras-logo'], { src: 'src/imagen/carro-compras.svg', alt: 'carro-compras' });
    ...
    const searchImg = createElem('img', [], { src: 'src/imagen/img-buscador.svg', alt: '', width: '25px' });
    ...
    const h1 = createElem('h1', [], { textContent: 'Fertilizantes' });
    ...
    function crearCardProducto(srcImg, titulo, precio) {
      ...
      const imgFav = createElem('img', [], { src: 'src/imagen/favoritos.svg', alt: '', width: '15px' });
      ...
      const imgCarro = createElem('img', [], { src: 'src/imagen/carro-compras.svg', alt: '', width: '15px' });
    ...
    row1.appendChild(crearCardProducto('src/imagen/img-fertilizantes/1.svg', 'Abono orgánico Biocare 10Kg', '$27.900'));
    row1.appendChild(crearCardProducto('src/imagen/img-fertilizantes/2.svg', 'Tierra para Jardinería', '$7.900'));
    row1.appendChild(crearCardProducto('src/imagen/img-fertilizantes/3.svg', 'Fertilizante Natural', '$11.900'));
    ...
    row2.appendChild(crearCardProducto('src/imagen/img-fertilizantes/4.svg', 'Fertilizante Rebrote 10kg', '$63.500'));
    row2.appendChild(crearCardProducto('src/imagen/img-fertilizantes/5.svg', 'Hidrofollaje', '$25.600'));
    row2.appendChild(crearCardProducto('src/imagen/img-fertilizantes/6.svg', 'Fertiespecial 46kg', '$93.300'));
    ...
    ['Accesorios', 'Agroindustriales', 'Cabo', 'Cerca eléctrica', 'Grapa', 'Lima', 'Pala', 'Polisombra', 'Respuestos', 'Siembra'].forEach(subtipo => {
      const label = createElem('label', ['checkbox-label']);
      label.style.paddingLeft = '60px';
      const input = createElem('input', [], { type: 'checkbox' });
    ...
    const row3 = createElem('div', ['row', 'row-cols-1', 'row-cols-md-4', 'g-4']);
    row3.style.marginTop = '1px';
    row3.appendChild(crearCardProducto('src/imagen/img-fertilizantes/7.svg', 'Tierra Mejorada 2kg', '$9.900'));
    row3.appendChild(crearCardProducto('src/imagen/img-fertilizantes/8.svg', 'Fuerza Concentrada', '$77.900'));
    row3.appendChild(crearCardProducto('src/imagen/img-fertilizantes/9.svg', 'Fertilizante Vegano 2kg', '$25.000'));
    ...
    function createFooter() {
        ...
        imgLogo.src = 'src/imagen/img-logo.svg'; 
        imgLogo.alt = 'logo';
